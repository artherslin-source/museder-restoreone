    ...
    public static function enqueue_assets( $hook ) {
        ...
        wp_localize_script( 'museder-restoreone-admin', 'MusederRestoreOneAdmin', [
            ...
            'strings'        => [
                ...
                'restoreCancelled'     => __( 'Restore Cancelled', 'museder-restoreone' ),
                'restoreExecutionSummaryTitle' => __( 'Will execute', 'museder-restoreone' ),
                'restoreScopeFullLabel' => __( 'Full site (files + database)', 'museder-restoreone' ),
                'restoreScopeContentLabel' => __( 'wp-content only (no database import)', 'museder-restoreone' ),
                'restoreScopeDbLabel'   => __( 'Database only', 'museder-restoreone' ),
                'restoreWillImportDb'   => __( 'Database import: yes', 'museder-restoreone' ),
                'restoreWillSkipDb'     => __( 'Database import: no', 'museder-restoreone' ),
                'restoreWillPreBackupForced' => __( 'Pre-restore snapshot: required on populated sites and cannot be turned off.', 'museder-restoreone' ),
                'restoreWillPreBackupOn' => __( 'Pre-restore snapshot: enabled', 'museder-restoreone' ),
                'restoreWillPreBackupOff' => __( 'Pre-restore snapshot: disabled', 'museder-restoreone' ),
                'restoreContentOnlyDbWarning' => __( 'This mode does not restore posts, pages, settings, users, or trash state from the backup database.', 'museder-restoreone' ),
